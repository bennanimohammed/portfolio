  ...
  project: {
  ...
  },
    {
      ...
      project: {
        ...
        videos: [
          {
            src: "/svn.mp4",
            alt: "Logistics management system demo",
            type: "video" as const,
          },
    ...
    },
    {
      ...
      project: {
        ...
        videos: [
          {
            src: "/kh-autosolutions.mp4",
            alt: "Automotive garage system demo",
            type: "video" as const,
          },
    ...
    <section id="experience" className="py-20 bg-muted/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-5xl font-bold text-balance mb-4 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">Professional Experience</h2>
